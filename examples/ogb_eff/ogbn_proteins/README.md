...
### Test the RevGNN-Wide model by multiple view inference (e.g. 10 times with 3 parts) (pre-trained model, [download](https://github.com/lightaime/deep_gcns_torch/tree/master/examples/ogb_eff/ogbn_proteins) from Google Drive)
...
### Test the RevGNN-Wide model by single inference (e.g. 1 times with 5 parts) (pre-trained model, [download](https://github.com/lightaime/deep_gcns_torch/tree/master/examples/ogb_eff/ogbn_proteins) from Google Drive)
