...
class OptInit():
    def __init__(self):
        ...
        # base
        parser.add_argument('--task', type=str, default='sem_seg_dense')
        ...
        if not args.model_name:
            if args.task =='sem_seg_dense':
                args.model_name = 'DenseDeepGCN'
            elif args.task =='sem_seg':
                args.model_name = 'SparseDeepGCN'
            else:
                raise NotImplementedError('===> Sorry. Task is not supported now. We support:sem_seg, sem_seg_dense')
